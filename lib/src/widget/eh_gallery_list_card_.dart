...
class EHGalleryListCard extends StatelessWidget {
  ...
  Future<void> _quickCopyTorrent(Gallery gallery) async {
    try {
      ...
      // Prefer non-outdated torrents
      GalleryTorrent? torrent = torrents.where((t) => !t.outdated).firstOrNull ?? torrents.first;
      await FlutterClipboard.copy(torrent.magnetUrl);
      toast('hasCopiedToClipboard'.tr);
    } catch (e) {
      toast('getGalleryTorrentsFailed'.tr);
    }
  }
